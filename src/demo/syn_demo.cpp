 ...
 * of both independent and dependent tasks without vehicle kinematic constraints ***/
...
int main(int argc, char** argv )
{
	...
	// std::string pic_name = "result_syn_" + std::to_string(agents_group[0].num_agents_) + "v.jpg";
	imwrite("result_syn.jpg",vis_img);
