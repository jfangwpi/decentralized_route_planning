/*** This code is the demo of decentralized task assignment 
 * of both independent and dependent tasks with vehicle kinematic constraints ***/
...
int main(int argc, char** argv){
	...
	//while(agent[0].Iter < 2){
		...
		TaskAssignment::bundle_add(tasks,grid_graph,lifted_graph, tile_traversal_data, grid, agents_group);
	...
	imwrite("result_syn_cbta.jpg",vis_img);
